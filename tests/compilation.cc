...
TEST_SUITE("Engine")
{
    ...
    TEST_CASE("Basic circuit")
    {
        ...
        Component* button = *e_board.add_component("button", 1, 1, Direction::N);
        Component* led = *e_board.add_component("led", 3, 1, Direction::N);
    ...
    TEST_CASE("Multiple connections to same single-tile component")
    {
        ...
        Component* led = *e_board.add_component("led", 1, 1, Direction::N);
    ...
    TEST_CASE("Special circuit case 1")
    {
        ...
        Component* button = *e_board.add_component("button", 1, 0, Direction::N);
        Component* led1 = *e_board.add_component("led", 0, 2, Direction::N);
        Component* led2 = *e_board.add_component("led", 1, 3, Direction::N);
    ...
    TEST_CASE("Single-tile component rotation")
    {
        ...
        Component* npn = *e_board.add_component("npn", 1, 1, Direction::N);
