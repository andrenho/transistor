...
void GUI::setup_font()
{
    ...
    io->Fonts->AddFontFromMemoryTTF((void *) frontend_resources_fonts_Pixellari_ttf, frontend_resources_fonts_Pixellari_ttf_sz, 16, &cfg);
}

void GUI::error_window(Render const& render)
{
